      ...
      pages: [
        ...
        },
        {
          ...
          pageContent: '<h2>Exercise 2 - Pls Smile</h2>\n' +
              ...
              '<p><img style="margin-bottom: 2em" src="./iad-exercise_2/iad-exercise_2-7.gif" alt="smile detection"></p>' +
              '<p> </p>',
        },
        {
          link: {
          ...
          pageContent: '<h2>Exercise 3 - Ein Hauch von Liebe</h2>\n' +
              ...
              '<p>Confusing blue leds: What do the blinking patterns mean? (Source: creative.com [<a href="https://images.support.creative.com/audio_usb/free/free_pairing1.gif">1</a>] [<a href="https://images.support.creative.com/audio_usb/free/free_pairing2.gif">2</a>])</p>' +
              '<ol start="2">\n' +
              '<li>\n' +
              ...
              '<div id="img-txt"<p><div id="img"><img id="presentation" src="./iad_exercise_3/iad-exercise_3-13.jpeg" alt="final presentation"></div></p>' +
              '<div id="txt"><p>When we invited our fellow students to test the artifact, we were happy to get positive feedback. The interaction was slightly uncomfortable for everyone, but in a way that, when the LED finally fired, the small success and relief of being done with the interaction caused most of them to smile or laugh.</p>\n' +
